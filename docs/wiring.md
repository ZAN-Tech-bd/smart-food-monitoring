...
|-------------------|-----------|-------|
| DHT11 data         | GPIO 4    | Add a 10kΩ pull-up resistor between data and 3.3V if your module doesn't already have one. |
...
Power: DHT11, MQ-5, and the LCD's I2C backpack typically run off 5V (VIN) with logic-level I/O tolerant of 3.3V from the ESP32; HX711 modules are usually fine on 3.3V or 5V — check your specific board. Common ground between the ESP32, all sensors, and the load cell amplifier is required.
